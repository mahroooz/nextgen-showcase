...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "NextGen Digital Solutions — We build what's next" },
      { name: "description", content: "NextGen Digital Solutions designs and builds digital products that move companies forward. Web, mobile, AI, cloud and design — under one roof." },
      { name: "author", content: "NextGen Digital Solutions" },
      ...
      { name: "twitter:title", content: "NextGen Digital Solutions" },
